...
def normalize(adata, filter_min_counts_genes=False,filter_min_counts_cells=True, size_factors=True, normalize_input=False, logtrans_input=True):

    if filter_min_counts_genes:
        sc.pp.filter_genes(adata, min_counts=1)
        
    if filter_min_counts_cells:
